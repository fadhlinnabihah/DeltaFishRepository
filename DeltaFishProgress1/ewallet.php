...
<div class="col-12">Choose e-wallet: <select type="fpassq" class="form-control mb-4" name="fpassq" id="fpassq" required>
                <option value="" selected>Select</option>
                <option value="mothername" <?php if(isset($_GET['edit'])) if($editrow['FPASSQ']=="What is your mother name?") echo "selected"; ?>>Touch n Go</option>
                <option value="birthplace"  <?php if(isset($_GET['edit'])) if($editrow['FPASSQ']=="What is your birthplace?") echo "selected"; ?>>Shopeepay</option>
                <option value="birthplace"  <?php if(isset($_GET['edit'])) if($editrow['FPASSQ']=="What is your birthplace?") echo "selected"; ?>>Grabpay</option>
                <option value="birthplace"  <?php if(isset($_GET['edit'])) if($editrow['FPASSQ']=="What is your birthplace?") echo "selected"; ?>>BOOST</option>
            </select>
        </div>
