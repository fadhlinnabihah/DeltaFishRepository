        ...
        <table id="productlist" style="width: 100%; height: 100%;" class="table-dark table-striped table-bordered hover" id="table">
          ...
          foreach($result as $readrow) {
            ...
            <tr>
              ...
              <td><?php echo 'RM'.$readrow['PRICE']; ?></td>
              ...
              <td>
                ...
                <a href="sellerpage.php?delete=<?php echo $readrow['ID']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs" role="button">Delete</a>
